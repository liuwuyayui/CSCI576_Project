                ...
                if(index%2 == 0){
                    ...
                    for(int j = 0; j < doubleOriginalHSV1.length; j++){
                        for(int k = 0; k < doubleOriginalHSV1[0].length; k++){
                            ...
                            hueSaturationValueScore[2]+=((0.2126*intRGBFramePair[j][k][0][0]+0.7152*intRGBFramePair[j][k][0][1]+0.0722*intRGBFramePair[j][k][0][2])+(0.2126*intRGBFramePair[j][k][1][0]+0.7152*intRGBFramePair[j][k][1][1]+0.0722*intRGBFramePair[j][k][1][2]));
                            /*
                            if(index < 1000) {
